...
![angular-module-template-example](angular-module-template-example.png)

Run `ng serve --port 8081` for a dev server. Navigate to `http://localhost:8081/`. The app will automatically reload if you change any of the source files.

For instruction, please visit:
> [Angular 15 example: CRUD with Rest API](https://www.bezkoder.com/angular-module-template-example/)
...
> [Angular 15 + Spring Boot example](https://www.bezkoder.com/spring-boot-angular-module-template/)
